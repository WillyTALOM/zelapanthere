...
class PaymentController extends AbstractController
{
    ...
    public function success(Request $request, CartService $cartService, Order $order, OrderStateRepository $orderStatusRepository, ManagerRegistry $managerRegistry, MailerInterface $mailer): Response
    {
        if ($request->headers->get('referer') !== 'https://checkout.stripe.com/') { // vérifie qu'on vient bien de Stripe
            return $this->redirectToRoute('cart');
        }
